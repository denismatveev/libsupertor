...
./autogen.sh && ./configure --enable-shared-libs --host=arm-linux-gnueabihf --with-libm-dir=/usr/arm-linux-gnueabihf/lib/ --with-libevent-dir=/home/dmat/projects/libs-cross-compilation --enable-static-openssl --with-openssl-dir=/home/dmat/projects/libs-cross-compilation --with-zlib-dir=/home/dmat/projects/libs-cross-compilation --with-libcurl-dir=../curl-7.58.0/lib/.libs/ --with-libpthread-dir=/usr/arm-linux-gnueabihf/lib/ --with-libdl-dir=/usr/arm-linux-gnueabihf/lib/
